...
class Phone(models.Model):
    ...
    body_other = models.TextField(verbose_name='دیگر', max_length=500, blank=True, null=True)
    ...
    display_other = models.TextField(verbose_name='دیگر', max_length=500, blank=True, null=True)
    ...
    hardware_ram = models.CharField(verbose_name='حافظه RAM', max_length=200, blank=True, null=True)
    hardware_battery = models.CharField(verbose_name='باتری', max_length=200, blank=True, null=True)
    hardware_other = models.TextField(verbose_name='دیگر', max_length=500, blank=True, null=True)

    back_cam_pic_quality = models.CharField(verbose_name='وضوح تصویر', max_length=200, blank=True, null=True)
    back_cam_lens = models.CharField(verbose_name='لنز', max_length=200, blank=True, null=True)
    ...
    back_camera_other = models.TextField(verbose_name='دیگر', max_length=500, blank=True, null=True)

    front_cam_pic_quality = models.CharField(verbose_name='وضوح تصویر', max_length=200, blank=True, null=True)
    front_cam_lens = models.CharField(verbose_name='لنز', max_length=200, blank=True, null=True)
    ...
    front_camera_other = models.TextField(verbose_name='دیگر', max_length=500, blank=True, null=True)
    ...
    storage_other = models.TextField(verbose_name='دیگر', max_length=500, blank=True, null=True)
    ...
    def get_absolute_url(self):
        return reverse("phone:detail", kwargs={"id": self.id})
